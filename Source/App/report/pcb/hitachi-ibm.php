<h4 class="text-danger">List of donor Hitachi/IBM PCB:</h4>
...
$result = mysqli_query($permission->dbConnect(), "SELECT * FROM DONOR_PCB_INVENTORY AS D, DONOR_PCB_HITACHI_IBM AS HI
