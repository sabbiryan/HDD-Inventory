<h4 class="text-danger">List of donor Western Digital PCB:</h4>
...
$result = mysqli_query($permission->dbConnect(),"SELECT * FROM DONOR_PCB_INVENTORY WHERE MODEL_NAME='Western Digital' ORDER BY TRACK_NO ASC ");
