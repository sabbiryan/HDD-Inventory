<h4 class="text-danger">List of donor Samsung HDD:</h4>
...
$result = mysqli_query($permission->dbConnect(), "SELECT * FROM DONOR_HDD_INVENTORY AS D, DONOR_SAMSUNG AS S
          WHERE D.MODEL_NAME='Samsung' AND D.TRACK_NO=S.TRACK_NO ORDER BY D.TRACK_NO ASC ");
