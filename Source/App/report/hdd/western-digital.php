<h4 class="text-danger">List of donor Western Digital HDD:</h4>
...
$result = mysqli_query($permission->dbConnect(), "SELECT * FROM DONOR_HDD_INVENTORY AS D, DONOR_WESTERN_DIGITAL AS WD
          WHERE D.MODEL_NAME='Western Digital' AND D.TRACK_NO=WD.TRACK_NO ORDER BY D.TRACK_NO ASC ");
